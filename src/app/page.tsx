...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center min-h-screen bg-gray-500">

      <MainScene/>

      <main className="z-10 p-2 max-w-5xl">
        
        <header className='flex p-4 pt-1 rounded-lg justify-between'>
